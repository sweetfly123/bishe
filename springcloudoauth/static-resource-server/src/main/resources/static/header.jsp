...
<ul id="top_menu">
    ...
    <li><a href="#ddd" id="sign-in" class="login" title="Sign In">Sign In</a></li>
    ...
    <li>
        <div class="dropdown dropdown-user">
            ...
            <div class="dropdown-menu">
                <ul>
                    <li><a href="#sign-in-dialog" id="sign-in" title="Sign In">登录</a></li>
                    <li><a href="#">注销</a></li>
...
<nav id="menu" class="main-menu">
    <ul>
        <li><span><a href="#0">首页</a></span>
            <ul>
                <li><a href="index_pre.html">Home version 1</a></li>
        ...
        <li><span><a href="#0">操作</a></span>
            <ul>
                ...
                <li><a href="login_pre.html">Login</a></li>
