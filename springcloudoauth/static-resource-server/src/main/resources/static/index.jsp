    ...
    <main>
        <section class="hero_single version_2">
            <div class="wrapper">
                <div class="container">
                    <h3>订购您特有的经历</h3>
                    <p>介绍世界各地的顶级旅游，酒店和餐馆</p>
                        <a href="#sign-in-dialog" id="sign-in" class="login" title="Sign In">dddddddf</a>
                    <form>
                        <div class="row no-gutters custom-search-input-2">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <input class="form-control" type="text" placeholder="酒店-城市...">
                                    <i class="icon_pin_alt"></i>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <input class="form-control" type="text" name="dates" placeholder="时间..">
                                    <i class="icon_calendar"></i>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="panel-dropdown">
                                    <a href="#">宾客 <span class="qtyTotal">1</span></a>
            ...
            <div id="reccomended" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="box_grid">
                        <figure>
                            <a href="#0" class="wish_bt"></a>
                            <a href="tour-detail.html"><img src="img/tour_4.jpg" class="img-fluid" alt="" width="800"
                                                            height="533">
                                <div class="read_more"><span>Read more</span></div>
                            </a>
                            <small>Museum</small>
                ...
                <div class="item">
                    <div class="box_grid">
                        <figure>
                            <a href="#0" class="wish_bt"></a>
                            <a href="tour-detail.html"><img src="img/tour_5.jpg" class="img-fluid" alt="" width="800"
                                                            height="533">
                                <div class="read_more"><span>Read more</span></div>
                            </a>
                            <small>Walking</small>
    ...
    <form>
        <div class="sign-in-wrapper">
            ...
            <div class="text-center">
                还未注册? <a href="register.html">注册</a>
            </div>
            <div id="forgot_pw">
                <div class="form-group">
